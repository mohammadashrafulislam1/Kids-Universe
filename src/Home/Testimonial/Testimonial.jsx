const Testimonial = () => {
  ...
  <div className="hero-content flex flex-wrap gap-10 sm:px-52 justify-center justify-center">
    ...
    <div>
      ...
      <p className="py-6">I bought some toys for my kids and their products are awesome. Moreover, they provide 5 star service they are fantastic. Highly recommended.</p>
    </div>
  </div>
</div>
