...
const Footer = () => {
  ...
  <a className="btn btn-ghost normal-case text-xl">Kids Universe</a>
    <p>Kids Universe Ltd.<br/>Providing best toys in the world.</p>
  </div> 
  <div>
    ...
    <p className="font-bold">Location:<br/>Beanibazar, Sylhet</p>
  </div>
...
<div className="bg-neutral text-center mt-0 pb-3 text-yellow-200">
    <p>All right reserved @kids-universe</p>
  </div>
</>
    );
};
